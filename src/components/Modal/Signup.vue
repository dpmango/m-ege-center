    ...
    <div class="modal__wrapper" @click="() => setModal(null)">
      <div class="modal__body" @click.stop v-scroll-lock="activeModal === 'signup'">
        ...
        <div class="modal__subtitle">
          Заполните форму ниже и сотрудники <br />ЕГЭ-Центра свяжутся с вами
        </div>
        <ValidationObserver
          ref="form"
          v-slot="{ invalid }"
        ...
        >
          ...
          <div class="form__checkboxes row">
            <div class="col col-6">
              <UiCheckbox
          ...
          <div class="form__cta">
            <UiButton type="submit" size="big" block>Записаться на курсы</UiButton>
          </div>
        </ValidationObserver>
      </div>
    </div>
